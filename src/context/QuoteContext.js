...
export const QuoteProvider = ({ children }) => {
  ...
  const getFallbackQuote = () => ({
    ...
    quote_text:
      "La persévérance est la clé du succès, même face aux obstacles techniques.",
  ...
  const createFallbackArticle = (quote, today) => ({
    ...
    content: {
      ...
      context: quote?.quote_author
        ? `${quote.quote_author} est reconnu pour sa sagesse et sa perspicacité unique.`
        : "Une pensée profonde qui mérite réflexion.",
      points: [
